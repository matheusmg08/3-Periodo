...
public class App {
    ...
    public static int hash(String valor){
        valor = valor.toLowerCase(); //transforma a String toda em letras minúsculas
        //System.out.println(valor.charAt(0)); //posição que quero pegar da String
        int codigoAscii = valor.charAt(0);
        int resto = (codigoAscii+7)%26; //tabela ask
