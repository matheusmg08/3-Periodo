...
public class Main {
    public static void main(String[] args) {
        ...
        Livro obj1 = new Livro("Batman");
        obj1.setAutor("Matheus");
        obj1.setAnoPublicacao(1994);
        ...
        obj2.setAutor("Carmen");
        obj2.setAnoPublicacao(1700);
        //System.out.println(obj2);

        Livro obj3 = new Livro("Harry Potter");
        obj3.setAutor("Warner");
        obj3.setAnoPublicacao(1980);
        //System.out.println(obj2);
        ...
        user1.setEmail("matheus@hotmail.com");
